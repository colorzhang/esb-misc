...
-----------------------------------------------------------------
./src/test/java/org/mule/application/mulejerseyldap/MulejerseyLdapTestCase.java
...
-----------------------------------------------------------------
./src/test/resources/mulejerseyldap-functional-test-config.xml

Defines the Mule configuration for the MulejerseyLdapTestCase.java.
...
artifactId=mulejerseyldap
description=Mule 3.x, Jersey and Ldap configuration example.
muleVersion=3.1.0
packagePath=com/mycompany/mule
forgeProject=n
transports=http,stdio,vm
modules=client,jersey,spring-extras,spring-security,xml

version=1.0-SNAPSHOT
groupId=org.mule.application
basedir=/Users/jaskiratbhatia/Desktop/cases
--------------------------------------------------------------------